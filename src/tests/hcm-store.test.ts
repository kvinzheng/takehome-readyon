...
describe('hcm-store: balance reads', () => {
...
describe('hcm-store: deductBalance', () => {
...
describe('hcm-store: restoreBalance', () => {
...
describe('hcm-store: anniversary bonus', () => {
...
describe('hcm-store: request lifecycle', () => {
  ...
  it('updates request status to denied with HCM error', () => {
    ...
    expect(updated!.hcmError).toBe('Balance exhausted');
  });
});
