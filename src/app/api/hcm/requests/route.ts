...
import type { HcmSubmitRequestBody } from "@/types";
...
export async function POST(req: NextRequest) {
  const body: HcmSubmitRequestBody = await req.json();
  const scenario = req.headers.get("x-hcm-scenario");
...
/**
 * GET /api/hcm/requests?employeeId=X
 */
